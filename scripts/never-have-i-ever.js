document.addEventListener('DOMContentLoaded', async function() {
    ...
    const haveDoneBtn = document.getElementById('have-done-btn');
    ...
    try {
        gameData = await GameManager.loadGameData('never-have-i-ever');
        console.log('Never Have I Ever data loaded successfully:', gameData);
    ...
    haveDoneBtn.addEventListener('click', () => {
        if (fingersDown < 10) {
